...
class Booking(models.Model):
	...
	status = models.CharField(max_length=15,choices=status_choice,default=status_choice[0])
	amount = models.PositiveIntegerField(null=True,blank=True)
	booked_on = models.DateTimeField(auto_now_add=True)
	canceled_by = models.ForeignKey('usersapp.User',on_delete=models.CASCADE,related_name='canceled_by',null=True)
	ready_by = models.ForeignKey('usersapp.User',on_delete=models.CASCADE,related_name='ready_by',null=True)
	delivered_by = models.ForeignKey('usersapp.User',on_delete=models.CASCADE,related_name='delivered_by',null=True)